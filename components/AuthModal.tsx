    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 w-full max-w-sm relative">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          >
            {loading ? <div className="w-5 h-5 mx-auto border-2 border-t-transparent border-white rounded-full animate-spin" /> : (isLoginMode ? texts.authModalLoginButton : texts.authModalSignUpButton)}
          </button>
        </form>
        <button
          onClick={() => {
